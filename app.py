...
app.layout = html.Div(
    [
        ...
        dcc.Graph(id="FinIndic"),
    ]
)

# app callback
@app.callback(
    Output(component_id="FinIndic", component_property="figure"),
    [Input(component_id="Select Variable", component_property="value")],
)
...
def financial_indicator(selected_value):
    ...
    layout = go.Layout(
        title="Bank Data"
    )  # plot_bgcolor = "#999999", paper_bgcolor = "#000000"
